...
*/
console.log(MenuElemaniOlustur('kebap',72, 'etler'))
console.log(MenuElemaniOlustur('sushi', 75, 'uzakdoğu'))
console.log(MenuElemaniOlustur('mercimek', 40, 'çorbalar'))
...
burger.indirim= function (Kişiler){

	if(Kişiler=="öğretmen"||Kişiler=="öğrenci"){
...
function DegerledirmeEkle(dizi,isim,puan,geribildirim){
	...
	let yeni1={   isim: isim, puan: puan, geribildirim: geribildirim} ;                
...
function AnahtardanDegerlendirmeAl(dizi2,index ) {
	let n= dizi2[index].isim;
	let p= dizi2[index].puan;
	let g= dizi2[index].geribildirim;
	return n + " isimli kişi "+ p + " puan verdi ve şunları yazdı:"+ g
...
function SonDegerlendirmeyiAl(dizi3) {
	let a= dizi3[dizi3.length-1].isim;
	let b= dizi3[dizi3.length-1].puan;
	let c= dizi3[dizi3.length-1].geribildirim;
